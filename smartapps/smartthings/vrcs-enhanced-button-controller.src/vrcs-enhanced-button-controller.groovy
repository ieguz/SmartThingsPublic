/**
 *	Enhanced VRCS Button Controller
 *
 *	Author: Iskender Eguz, based on Brian Dahlem's VRCS Button Controller App Dated 2015-3-17
 *	Date: 2016-11-21
 */
definition(
    name: "VRCS Enhanced Button Controller",
